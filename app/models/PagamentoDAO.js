...
PagamentoDAO.prototype.pendentes = function( idVenda, callback) {
	this._connection.query('select * from PAGAMENTO where recebimento is null order by id', idVenda, callback);	
}
